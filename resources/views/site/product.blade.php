    ...
    <div class="container container-240">
        <div class="product-bundle product-aff">
            <ul class="breadcrumb">
                ...
                <li class="active"><a href="{{route('category', $product->category->id)}}">{{$product->category->name}}</a></li>
                            ...
                            <div class="flex product-img-slide">
                                <div class="product-images">
                                    <div class="main-img js-product-slider">
                                        <a href="" class="hover-images effect"><img src="{{$product->getImage()}}" alt="photo" class="img-reponsive"></a>
                                    </div>
                                </div>
                                <div class="multiple-img-list-ver2 js-click-product">
                                    <div class="product-col">
                                        <div class="img active">
                                            <img src="{{$product->getImage()}}" alt="photo" class="img-reponsive">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
{{--                                    </div>--}}
                                    ...
                                    <div class="product-sku">
                                        <label>Код товара :</label><span> {{$product->code}}</span>
                                    </div>
